...
hadoop fs -copyFromLocal ~/Documents/BDA_demo/input_data/temperature-readings-small.csv "BDA/input/"
...
spark-submit --deploy-mode cluster --master yarn --num-executors 9 --driver-memory 2g --executor-memory 2g --executor-cores 4 demo.py
